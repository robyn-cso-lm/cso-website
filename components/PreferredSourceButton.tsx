import styles from './PreferredSourceButton.module.css';

interface Props {
  /** Extra class names to adjust spacing/position per-page. */
  className?: string;
...
/**
 * Deep-links to Google's "Preferred Sources" tool with our domain pre-filled,
 * so a reader can mark canadiansurrogacyoptions.com as a preferred source in
