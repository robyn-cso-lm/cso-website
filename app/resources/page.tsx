      ...
      <div className="res-body">
        ...
        <div className="section">
          ...
          <div className="guides-grid">
            {guides.map(g => (
              <div key={g.title} className={`guide-card${g.featured ? ' featured' : ''}`} style={{ position: 'relative' }}>
                ...
                <a href={g.href} className="btn btn-sm" style={{ textAlign: 'center', display: 'block' }}>{g.cta}</a>
              </div>
            ))}
          </div>
          ...
          <div className="helper-block">
            ...
            <p>
              If you are cold traffic and just trying to understand whether surrogacy is even realistic,
              start with the $27 guide before moving to the bigger, deeper resources.
            </p>
