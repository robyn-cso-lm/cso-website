...
export const metadata: Metadata = {
  ...
  description:
    "Find out what you're really getting into—before you commit. The honest guide to surrogacy from someone who's seen it from every side. $47.",
  alternates: {
    canonical: 'https://canadiansurrogacyoptions.com/guides/surrogate-readiness',
  },
  openGraph: {
    title: 'Surrogate Readiness Guide — $47 PDF Guide',
    description:
