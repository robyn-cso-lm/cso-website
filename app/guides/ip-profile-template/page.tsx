...
export const metadata: Metadata = {
  ...
  description:
    'Build a profile surrogates actually want to match with. Fill-in-the-blank framework, annotated examples, and Word/PDF templates. $47.',
  alternates: {
    canonical: 'https://canadiansurrogacyoptions.com/guides/ip-profile-template',
  },
  openGraph: {
    title: 'IP Profile Template Pack - $47 PDF Guide',
    description:
  ...
  return (
    <GuidePageTemplate
      ...
      guide={{
        ...
        price: 47,
        badge: 'Used by 400+ intended parents matching in Canada',
        hero: {
        ...
        included: [
          ...
          'Photo selection guide: what works and what reads as red flags',
